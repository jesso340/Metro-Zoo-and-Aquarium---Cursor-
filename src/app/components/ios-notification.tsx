...
export function IOSNotification({
  ...
  time = "now",
  title = "Hey Grace, check out this livestream!",
  body = "Baby penguins are hatching live now! We remembered they're your favorite 🐧",
  expanded = false,
  onAction,
  onClick,
        ...
        <div className="flex gap-2.5 px-3 py-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center justify-between mb-1">
              ...
              <span className="text-[12px] text-white/50 tracking-tight flex-shrink-0 ml-2">{time}</span>
            </div>
            
            {/* Notification Text */}
            <div className="flex items-center justify-between gap-2">
              <div className="flex-1">
                <p className="text-[14px] leading-[18px] text-white font-semibold mb-0.5 tracking-tight text-[#ffffffe6]">
                  {title}
                </p>
                <p className="text-[14px] leading-[18px] text-white/70 tracking-tight text-[#ffffffe6]">
                  {body}
                </p>
              </div>
            </div>
