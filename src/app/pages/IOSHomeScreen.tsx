...
export function IOSHomeScreen() {
  ...
  const handleZooAppClick = () => {
    // Navigate to the main Metro Zoo app home page
    navigate("/app");
  };

  const handleDragEnd = (_event: any, info: any) => {
    // If user drags up more than 100px, navigate to app
  ...
  return (
    ...
    >
              ...
              {app.isZooApp ? (
                <motion.button
                  whileHover={{
                    scale: 1.05,
                    boxShadow:
                      "0 12px 32px rgba(9, 105, 101, 0.6), 0 0 0 4px rgba(255, 255, 255, 0.4)",
                    transition: {
                      type: "spring",
                      stiffness: 400,
                      damping: 25,
                  ...
                  whileTap={{
                    scale: 0.88,
                    boxShadow:
                      "0 4px 16px rgba(9, 105, 101, 0.3), 0 0 0 3px rgba(255, 255, 255, 0.3)",
                    transition: {
                      type: "spring",
                      stiffness: 500,
                      damping: 30,
                  ...
                  onClick={handleZooAppClick}
                  className="w-[60px] h-[60px] rounded-[13px] bg-gradient-to-br from-[#096965] via-[#0A7571] to-[#0B827C] shadow-lg flex items-center justify-center text-2xl relative"
                  style={{
                    boxShadow: "0 8px 24px rgba(9, 105, 101, 0.4)",
                  }}
                >
                ...
                <button
                  className={`w-[60px] h-[60px] rounded-[13px] ${app.color} shadow-lg flex items-center justify-center text-2xl relative transition-all active:scale-[0.88]`}
                  style={{
      ...
      {/* Home Indicator - iOS swipe gesture bar */}
      <div className="absolute bottom-[6px] left-0 right-0 z-20 flex justify-center pointer-events-none">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
